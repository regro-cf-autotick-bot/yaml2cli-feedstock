...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaml2cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11439&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaml2cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaml2cli` can be installed with:

```
conda install yaml2cli
```

It is possible to list all of the versions of `yaml2cli` available on your platform with:
